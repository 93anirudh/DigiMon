...
electron.contextBridge.exposeInMainWorld("electronAPI", {
	...
	removeListeners: () => {
		...
		electron.ipcRenderer.removeAllListeners("llm:provider");
		electron.ipcRenderer.removeAllListeners("llm:quota-hit");
	},
	...
	setProvider: (provider) => electron.ipcRenderer.invoke("llm:setProvider", provider),
	getProvider: () => electron.ipcRenderer.invoke("llm:getProvider"),
	onProviderChange: (cb) => electron.ipcRenderer.on("llm:provider", (_e, p) => cb(p)),
	onQuotaHit: (cb) => electron.ipcRenderer.on("llm:quota-hit", (_e, data) => cb(data)),
